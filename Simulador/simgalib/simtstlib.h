/*
 * FILE: simtestlib.h, v.1.6.0, 3/18/2011
...
#define QUAD_FN_UPPER_RANGE_2 1.0
    //double quad_test_fn(int num_vars, int bits_per_var, double range_low_1, double range_high_1, double range_low_2, double range_high_2 ,vector<int> genes);
