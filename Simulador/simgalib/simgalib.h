/*
 * FILE: simgalib.h, v.1.6.0, 3/18/2011
...
namespace simgalib
{
    ...
    enum enumEvolutionaryModel {Darwinian=0, Lamarckian=1, Baldwinian=2};
...
// **********************************
    ...
    public:
        ...
        double (*eval_fn)(int, int, vector<double>, vector<double>, vector<int>);
        char szName[256];
        EvalFN(): num_parms(0), num_bits_per_parm(0), eval_fn(0)
        {
            ;
        }
        EvalFN(char *tmp_name, int tmp_num_parms, int tmp_num_bits_per_parm, vector<double> tmp_lower_range, vector<double> tmp_upper_range, double (*tmp_eval_fn)(int, int, vector<double>, vector<double>, vector<int>))
        {
